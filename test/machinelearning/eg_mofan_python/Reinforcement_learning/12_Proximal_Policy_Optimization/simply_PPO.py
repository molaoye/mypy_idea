...
class PPO(object):
    ...
    def __init__(self):
        ...
        with tf.variable_scope('loss'):
            ...
            if METHOD['name'] == 'kl_pen':# 如果用 KL penatil
    ...
    def update(self, s, a, r):
        ...
        else:   # clipping method, find this is better (OpenAI's paper)# 如果用 clipping 的方法
...
for ep in range(EP_MAX):
    ...
    for t in range(EP_LEN):    # in one episode
        ...
        buffer_s.append(s)
        buffer_a.append(a)
        buffer_r.append((r+8)/8)    # normalize reward, find to be useful# normalize reward, 发现有帮助
        s = s_
        ep_r += r

        # update ppo
        if (t+1) % BATCH == 0 or t == EP_LEN-1:# 如果 buffer 收集一个 batch 了或者 episode 完了
            ...
            buffer_s, buffer_a, buffer_r = [], [], []# 清空 buffe
